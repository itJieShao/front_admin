<template>
  <div class="app-container">
    ...
    <el-table :data="detail.audit_process_detail" stripe style="width: 100%">
      <el-table-column prop="level" label="单品ID"> </el-table-column>
      <el-table-column prop="audit_user_name" label="单品名称" width="180">
      </el-table-column>
      <el-table-column prop="audit_at" label="包装规格" width="180">
      </el-table-column>
      <el-table-column prop="audit_at" label="成本预警价" width="180">
      </el-table-column>
      <el-table-column prop="audit_at" label="上次进货价" width="180">
      </el-table-column>
      <el-table-column prop="audit_at" label="本次进货价" width="180">
      </el-table-column>
      <el-table-column prop="audit_at" label="材料"> </el-table-column>
      <el-table-column prop="audit_at" label="调料"> </el-table-column>
      <el-table-column prop="audit_at" label="采购数量"> </el-table-column>
    </el-table>
  </div>
</template>

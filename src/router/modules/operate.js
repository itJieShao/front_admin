...
const operateRouter = {
    ...
    children: [
        ...
        {
            path: 'c_layout/index_bar',
            component: () => import('@/views/operate/c_layout/index_bar'),
            name: 'indexBar',
            hidden:true,
            meta: { title: '首页banner图', activeMenu:'/operate/c_layout' },
        },
        {
            path: 'c_layout/index_bar_add',
            component: () => import('@/views/operate/c_layout/index_bar/edit'),
            name: 'indexBarAdd',
            hidden:true,
            meta: { title: '新增首页banner图', activeMenu:'/operate/c_layout' },
        },
        {
            path: 'c_layout/index_bar_edit',
            component: () => import('@/views/operate/c_layout/index_bar/edit'),
            name: 'indexBarEdit',
            hidden:true,

...
const operateRouter = {
    ...
    children: [
        ...
        },
        {
            ...
            component: () => import('@/views/operate/c_active/reward/index'),
            name: 'reward',
            hidden:true,
            meta: { title: '打赏活动', activeMenu:'/operate/c_active' },
        },
        {
            path: 'c_active/reward_add',
            component: () => import('@/views/operate/c_active/reward/add'),
            name: 'rewardAdd',
            hidden:true,
            meta: { title: '打赏活动', activeMenu:'/operate/c_active' },
        },
        {
            path: 'c_active/reward_detail',
            component: () => import('@/views/operate/c_active/reward/detail'),
            name: 'rewardDetail',
            hidden:true,
            meta: { title: '打赏活动', activeMenu:'/operate/c_active' },
        },
